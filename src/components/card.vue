...
<template>
  <main class="relative w-full max-w-card mx-auto bg-white rounded-card overflow-hidden shadow-xl text-center sm:text-left lg:max-w-card-lg lg:flex lg:flex-row lg:overflow-visible">
    <img draggable="false" class="flex-grow-0 flex-shrink-0 basis-auto lg:w-285 lg:object-cover lg:object-left lg:rounded-r-none lg:rounded-l-card" src="/src/images/drawers.jpg" alt="">
